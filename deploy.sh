...
#       API_URL은 Cloud Run 런타임 환경변수로 주입합니다.         #
# ========================================================== #
...
# 2. 런타임 주입 환경 변수 설정 (Cloud Run 컨테이너 실행 시점에 주입됨)
API_URL="https://tones-server-257637179317.us-central1.run.app"
...
if [ $? -eq 0 ]; then
    ...
    echo "   - 환경 변수 API_URL이 Cloud Run 런타임에 정상 주입되었습니다."
    echo "=========================================================="
else
