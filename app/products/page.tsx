    ...
    <div className="flex-1 flex flex-col p-10 bg-[#f4f5f7] overflow-y-auto w-full h-full">
      ...
      <div className="flex justify-between items-end mb-8">
        <div>
          ...
          <p className="text-[14px] text-gray-500 mt-2 font-medium">등록된 상품과 리뷰 데이터를 관리하세요.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex items-center gap-5">
          ...
          <div className="flex flex-col">
            <span className="text-[13px] font-bold text-gray-500 mb-1">등록 상품</span>
            <span className="text-2xl font-extrabold text-gray-900 tracking-tight">11개</span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex items-center gap-5">
          <div className="w-14 h-14 rounded-full bg-pink-50 flex items-center justify-center border border-pink-100 shrink-0">
            <MessageSquare className="text-[#ff477e]" size={24} strokeWidth={2} />
          </div>
          <div className="flex flex-col">
            <span className="text-[13px] font-bold text-gray-500 mb-1">분석 활성 상품</span>
            <span className="text-2xl font-extrabold text-gray-900 tracking-tight">11개</span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex items-center gap-5">
          ...
          <div className="flex flex-col">
            <span className="text-[13px] font-bold text-gray-500 mb-1">누적 리뷰</span>
            <span className="text-2xl font-extrabold text-gray-900 tracking-tight">4,286건</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 flex flex-col flex-1 min-h-0 pb-12">
        <h2 className="text-[18px] font-extrabold text-gray-900 tracking-tight mb-6">전체 상품</h2>
        ...
        <div className="flex justify-between items-center mb-6 gap-4">
          ...
          <div className="relative">
            ...
            <ChevronDown className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none" size={16} strokeWidth={2.5} />
          </div>
        </div>
          ...
          <table className="w-full text-left border-collapse min-w-[800px]">
            <thead>
              <tr className="border-b border-gray-100">
                <th className="py-4 font-bold text-[14px] text-gray-800 w-[45%]">상품 정보</th>
                <th className="py-4 text-center font-bold text-[14px] text-gray-800">카테고리</th>
                <th className="py-4 text-center font-bold text-[14px] text-gray-800">누적 리뷰</th>
                <th className="py-4 text-center font-bold text-[14px] text-gray-800">최근 업데이트</th>
                <th className="py-4 text-center font-bold text-[14px] text-gray-800 w-[140px]">분석 활성</th>
              </tr>
            </thead>
            <tbody>
              {products.map((prod) => (
                <tr key={prod.id} className="border-b border-gray-100 last:border-0 hover:bg-gray-50/50 transition-colors group">
                  <td className="py-5">
                    <div className="flex items-center gap-5">
                      <div className={`w-16 h-16 ${prod.color} border border-gray-100 rounded-xl flex items-center justify-center shrink-0 shadow-sm`}>
                  ...
                  <td className="py-5 text-center text-[14px] text-gray-600 font-bold">{prod.category}</td>
                  <td className="py-5 text-center text-[14px] text-gray-600 font-bold">{prod.reviews}건</td>
                  <td className="py-5 text-center text-[14px] text-gray-600 font-bold">{prod.updated}</td>
                  <td className="py-5">
                    <div className="flex justify-center">
                      ...
                      >
                        <div className={`w-[18px] h-[18px] bg-white rounded-full shadow-sm transition-transform ${prod.active ? 'translate-x-[20px]' : 'translate-x-0'}`}></div>
                      </div>
                    </div>
                  </td>
                </tr>
